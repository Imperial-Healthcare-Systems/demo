          ...
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-5 text-center">
            <Reveal kind="fade">
              {/* The client's `.section-tag.emerald`, in the site's own green
                  ...
                  nothing to click. */}
              <span className="inline-flex items-center rounded-full border border-green-500/30 bg-green-500/10 px-3.5 py-1.5 font-mono text-[0.6875rem] tracking-[0.16em] text-green-400 uppercase">
