              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <a
                    ...
                    className="flex min-h-11 w-fit items-center text-[0.8125rem] font-medium text-navy-600 underline underline-offset-4 transition-colors hover:text-navy-800 md:min-h-0 md:block"
                  >
                    {route.email}
                  </a>
                </div>
            ...
            >
              ...
              <address className="flex flex-col gap-4 text-[0.875rem] not-italic text-ink-2">
                ...
                <a
                  ...
                  className="flex min-h-11 items-center gap-3 transition-colors hover:text-navy-600 md:min-h-0"
                >
                  <Icon
                    name="mail"
