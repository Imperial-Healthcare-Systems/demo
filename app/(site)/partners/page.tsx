                  ...
                  <div className="relative flex flex-1 flex-col gap-2 px-7 pt-10 pb-7">
                    ...
                    */}
                    <a
                      ...
                      className={`relative mt-auto inline-flex w-fit items-center gap-2 pt-8 font-mono text-[0.75rem] md:text-[0.6875rem] tracking-[0.14em] uppercase transition-colors duration-200 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-current ${tone.link}`}
                    >
                      Become a partner
                      <Icon
                        name="arrowRight"
          ...
          >
            ...
            <div className="relative flex flex-col items-start gap-7 p-8 md:p-12 lg:flex-row lg:items-center lg:gap-10 lg:py-14">
              ...
              <div className="flex shrink-0 flex-col items-start gap-2.5 lg:items-end">
                ...
                <span className="font-mono text-[0.75rem] md:text-[0.6875rem] tracking-[0.12em] text-ink-inv-3">
