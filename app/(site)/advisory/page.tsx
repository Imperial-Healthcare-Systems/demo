                  ...
                  <div className="relative grid gap-7 lg:grid-cols-12 lg:gap-10">
                    <div className="flex items-start gap-5 lg:col-span-5">
                      ...
                      <div className="flex flex-col gap-2">
                        <span
                          className={`font-mono text-[0.75rem] md:text-[0.6875rem] tabular transition-colors duration-300 ${tone.index}`}
                        >
                          {service.index}
                        </span>
                    ...
                    <div className="lg:col-span-3">
                      <p className="mb-3 font-mono text-[0.75rem] md:text-[0.625rem] uppercase tracking-[0.18em] text-ink-3">
                        Focus areas
                      </p>
          ...
          <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
            ...
            <ol className="flex flex-col lg:col-span-7">
              {advisoryPage.approach.steps.map((step, i) => (
                ...
                >
                  <span className="font-mono text-[0.75rem] md:text-[0.6875rem] tabular text-sky-400">
                    0{i + 1}
                  </span>
